...
<body>
    ...
    <main class="modulos">
        ...
        <div class="titulo-insumo">
            <p class="titulo-insumo-text">Registrarse</p>
        </div>    

        <form action="alta_insumo_sql.php" method="post" class="formulario-insumo">
            <div class="inputs">
                <label for="tipoDoc" class="label-input">Tipo Documento:</label>
                <input type="text" id="tipoDoc" name="tipoDoc" placeholder="Tipo Documento">
            </div>
            <div class="inputs">
                <label for="nroDoc" class="label-input">Descripcion:</label>                
                <input type="text" id="nroDoc" name="nroDoc" placeholder="Número de Documento">
            </div>
            <div class="inputs">
            ...
            <div class="inputs">
                <label for="mail" class="label-input">E-mail:</label>      
